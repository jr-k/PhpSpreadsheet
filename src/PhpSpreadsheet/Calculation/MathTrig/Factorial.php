...
class Factorial
{
     ...
     *
     * @return array<float|int|string>|float|int|string Factorial, or a string containing an error
     ...
     * @param array|float $factVal Factorial Value, or can be an array of numbers
     *
     * @return array<float|int|string>|float|int|string Double Factorial, or a string containing an error
     *         If an array of numbers is passed as the argument, then the returned result will also be an array
     *            with the same dimensions
     */
