...
class Cotangent
{
     ...
     *
     * @return array<float|string>|float|string The cotangent of the angle
     ...
     * @param array|float $angle Number, or can be an array of numbers
     *
     * @return array<float|string>|float|string The hyperbolic cotangent of the angle
     *         If an array of numbers is passed as the argument, then the returned result will also be an array
     *            with the same dimensions
     */
     ...
     *
     * @return array<float|string>|float|string The arccotangent of the number
     *         If an array of numbers is passed as the argument, then the returned result will also be an array
     *            with the same dimensions
     */
     ...
     * @param array|float $number Number, or can be an array of numbers
     *
     * @return array<float|string>|float|string The hyperbolic arccotangent of the number
     *         If an array of numbers is passed as the argument, then the returned result will also be an array
     *            with the same dimensions
     */
