...
class Cosine
{
     ...
     *
     * @return array<float|string>|float|string cosine
     ...
     * @param mixed $number Should be numeric, or can be an array of numbers
     *
     * @return array<float|string>|float|string hyperbolic cosine
     *         If an array of numbers is passed as the argument, then the returned result will also be an array
     *            with the same dimensions
     */
     ...
     *
     * @return array<float|string>|float|string The arccosine of the number
     *         If an array of numbers is passed as the argument, then the returned result will also be an array
     *            with the same dimensions
     */
     ...
     * @param array|float $number Number, or can be an array of numbers
     *
     * @return array<float|string>|float|string The inverse hyperbolic cosine of the number, or an error string
     *         If an array of numbers is passed as the argument, then the returned result will also be an array
     *            with the same dimensions
     */
