...
class Sine
{
     ...
     *
     * @return array<float|string>|float|string sine
     ...
     * @param mixed $angle Should be numeric, or can be an array of numbers
     *
     * @return array<float|string>|float|string hyperbolic sine
     *         If an array of numbers is passed as the argument, then the returned result will also be an array
     *            with the same dimensions
     */
     ...
     *
     * @return array<float|string>|float|string The arcsine of the number
     *         If an array of numbers is passed as the argument, then the returned result will also be an array
     *            with the same dimensions
     */
     ...
     * @param array|float $number Number, or can be an array of numbers
     *
     * @return array<float|string>|float|string The inverse hyperbolic sine of the number
     *         If an array of numbers is passed as the argument, then the returned result will also be an array
     *            with the same dimensions
     */
